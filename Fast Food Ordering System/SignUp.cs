    ...
    public partial class SignUp : Form
    {
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if (rd.HasRows == true)
                {
                    MessageBox.Show(Email.Text + " Email address already exist!", "Failure", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    con.Close();
                }
                else
                {
                    con.Close();
                    string query = "insert into signup values(@firstname,@lastname,@email,@pass,@phonenum,@homeaddress,@cardnumber,@expirydate,@cvv)";
